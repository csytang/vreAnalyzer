...
public class GraphvizDotDraw
{
	...
	private byte[] get_img_stream(File dot, String type, String representationType)
	{
		...
		try {
			img = File.createTempFile("graph_", "."+type, new File(GraphvizDotDraw.TEMP_DIR));
			...
			System.err.println("Error:    in I/O processing of tempfile in dir " + GraphvizDotDraw.TEMP_DIR+"\n");
	...
	private File writeDotSourceToFile(String str) throws java.io.IOException
	{
		File temp;
		try {
			temp = File.createTempFile("graph_", ".dot.tmp", new File(GraphvizDotDraw.TEMP_DIR));
