...
public class PointsToGraph {
	...
	// Map: Map SootField to its NewExpr
	...
	///////////////////////////////////Constructor////////////////////////////////////////////////
	/**
	 * Constructs a new empty points-to graph.(contents: roots and heap)
	 */
	...
	//////////////////////////////////////////////////////////////////////////////////////////////
	public HashMap<Local,Set<AnyNewExpr>> getRoots(){
		return (HashMap<Local, Set<AnyNewExpr>>) roots;
	}
	public HashMap<AnyNewExpr,Map<SootField,Set<AnyNewExpr>>> getHeap(){
		return (HashMap<AnyNewExpr, Map<SootField, Set<AnyNewExpr>>>) heap;
	}
