 ...
 */
public interface ProgramRepresentation<MethodNode,CFGNode> {
	 ...
	 */
	public CFG getControlFlowGraph(MethodNode method);
	 ...
	 */
	public List<MethodNode> resolveTargets(MethodNode callerMethod, CFGNode callNode);
}
