 ...
 *
 */
public class DataFlowSolution<CFGNode,PointersToGraph> {
	
	/** A map of nodes to data flow values at the entry of the node. */
	private Map<CFGNode,PointersToGraph> inValues;
	
	/** A map of nodes to data flow values at the exit of the node. */
	private Map<CFGNode,PointersToGraph> outValues;
	 ...
	 */
	public DataFlowSolution(Map<CFGNode,PointersToGraph> inValues, Map<CFGNode,PointersToGraph> outValues) {
	 ...
	 * 
	 */
	public PointersToGraph getValueBefore(CFGNode node) {
	 ...
	 * 
	 */
	public PointersToGraph getValueAfter(CFGNode node) {
