...
public class setReducerClassUnd {
	public setReducerClassUnd(int argCount,JobVariable job,InvokeExpr expr,CFGDefUse inputducfg,NodeDefUses duNode,List<SootMethod>bindsm,List<Stmt>bindstmt,SootClass libReducer){
		if(argCount==1){
